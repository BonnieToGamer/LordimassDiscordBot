...
using LordimassDiscordBot.Commands;
using System.Collections.Generic;
using DSharpPlus.Entities;

namespace LordimassDiscordBot
{
    internal class Program
    {
        ...
        static async Task Main(string[] args) => new Program().InitBot(args);
        ...
        */
        ...
        {
            using DependencyCollectionBuilder deps = new DependencyCollectionBuilder();
